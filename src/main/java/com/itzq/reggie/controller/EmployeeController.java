...
public class EmployeeController {
    ...
    * */
    ...
    @PostMapping
    public R<Employee> save(HttpServletRequest httpServletRequest,@RequestBody Employee employee){
        log.info("新增员工，员工信息: {}",employee.toString());

        //设置初始密码，需要进行md5(LocalDateTime.now());
        employee.setPassword(DigestUtils.md5DigestAsHex("123456".getBytes()));

        /*
         * 公共字段用MP的自动填充,写在MyMetaObjecthandler类中
         * */
        //获取当前登录用户的id
